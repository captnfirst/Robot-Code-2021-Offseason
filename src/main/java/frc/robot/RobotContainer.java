...
import frc.robot.commands.Turret.Manually.TurretGroupCommand;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_driverController, 2).whenPressed(new TurnToAngle(180, m_robotDrive).withTimeout(5));
